...
![image](/assets/108282480-5e82fb80-718a-11eb-9c0c-691309813656.png)
...
![image](/assets/116779414-06684f80-aa7f-11eb-9a63-0231dd19f1be.png)

Then create a new Jenkins job. Select "Freestyle project".

![image](/assets/116780134-3154a280-aa83-11eb-8da9-3714a7909c48.png)
...
![image](/assets/116779732-bc806900-aa80-11eb-9b3b-0415fe67b172.png)
...
![image](/assets/116779858-80013d00-aa81-11eb-840d-c272df2e5937.png)

Proceed with configuring the job and set all required parameters like SCM and build steps.

![image](/assets/116779906-bb9c0700-aa81-11eb-8de1-448ba9ddffd3.png)
...
![image](/assets/116780412-5518e800-aa85-11eb-88b8-b35853381a91.png)
...
![image](/assets/116780055-bb503b80-aa82-11eb-90b0-6287cdbe56c2.png)

Select "Jenkins" and fill in all required fields:

![image](/assets/116780079-e33f9f00-aa82-11eb-8678-3f2b5638b196.png)
...
![image](/assets/116780159-6d880300-aa83-11eb-9c8d-242c76accde2.png)
...
![Configure](/assets/107243443-02fe9280-6a53-11eb-91e9-862a30c8daa3.png)

2. Note the plan key. In this case its "TES"
3. Configure the job to install node dependencies
![install](/assets/107244050-9f289980-6a53-11eb-8942-f508c2f643ce.png)
...
![Script](/assets/107244927-95536600-6a54-11eb-94d7-812ddbe6d917.png)

5. Set an input variable. Open Plan configuration:

![image](/assets/113134762-e2b8ac00-9229-11eb-863c-21697595ae04.png)

add  `grep` and `run` variables with an empty string as a default value

![image](/assets/113135720-1f38d780-922b-11eb-9fda-1efe77951d98.png)
...
![CI settings](/assets/107245863-a51f7a00-6a55-11eb-89d9-52f66402ba0f.png)

A project and plan keys can be found from URL:

![image](/assets/108208802-2ea80980-7132-11eb-9315-cf0465826f55.png)

2. Enable `run` option on Input Variables tab. This allows CI to send a report to a specific Run inside Testomatio.

![image](/assets/113136335-ebaa7d00-922b-11eb-9012-72d0d9646380.png)
...
![image](/assets/113136648-46dc6f80-922c-11eb-9e72-3a3356c5f647.png)

Select "Bamboo" profile in a list. Optionally, configure a Run Title and select a Test Plan.

![image](/assets/113136785-6f646980-922c-11eb-9dc0-d001bdf13610.png)

4. Launch a run and wait for the results.

![Runs view](/assets/107249055-f67d3880-6a58-11eb-9794-539cfa797002.png)

### GitLab CI

1. Add new trigger https://docs.gitlab.com/ee/ci/triggers/README.html#adding-a-new-trigger

![image](/assets/120804889-d1538f00-c54d-11eb-9566-d6a5e77e4945.png)
...
![image](/assets/145948594-853bed0b-b913-4d36-a0b6-6bee1faced91.png)
...
![image](/assets/120805051-ffd16a00-c54d-11eb-8a71-b9a9aaaa2e28.png)
...
![image](/assets/120805121-18da1b00-c54e-11eb-9ce5-01707b52634f.png)
...
![image](/assets/120805180-27283700-c54e-11eb-9459-8f86fb175ad1.png)
...
![image](/assets/107864711-9971f000-6e67-11eb-845d-9155aee9c85e.png)
...
![image](/assets/108279592-84f26800-7185-11eb-93a9-a5862f0548e4.png)
...
![image](/assets/108280170-78224400-7186-11eb-8b1c-86f399b630a3.png)
...
![image](/assets/113137542-57d9b080-922d-11eb-9672-c4a06c00255d.png)

You can pass more input variables if you set them in [Environment Configuration](#environment-configuration)

9. When the connection is saved, open a test and select "Run in CI". Select a target ref and click "Launch"

![image](/assets/108280786-5d040400-7187-11eb-810a-d639396c8a3e.png)
...
![image](/assets/201498799-e2fe4d62-dbc5-4b05-a6aa-158a6043a915.png)
...
![image](/assets/201498917-5d342aa9-495a-4329-b4da-25f8a86f56bb.png)

3. Create a new CI connection on Continuous Integration page in Settings in Testomat.io.

![image](/assets/201498983-384a2dd1-1c60-4d2f-bc52-2cb4cd39c0f4.png)
...
![image](/assets/201499184-cdaff7a1-7e13-482e-bf7b-43517963cec9.png)

8. Click "Variables" button

![image](/assets/201499223-64fd4478-e981-42cb-abff-accc9ebcfb4f.png)
...
![2022-11-13_01-56](/assets/201499260-77f27aed-64fb-4067-8943-3272a35f4072.png)
...
![image](/assets/201499290-cdc67537-e526-4274-84b1-fc5675de87ab.png)
...
![image](/assets/205988656-7b8e0b6c-860e-4d49-9e6b-c5f450fecb50.png)
...
![image](/assets/113130343-a46cbe00-9224-11eb-8808-7fc096d2a335.png)
...
![image](/assets/108283747-85dac800-718c-11eb-918b-50d3aa7a27da.png)
...
![image](/assets/108284411-d7378700-718d-11eb-99f7-590dedfc6d0a.png)
