---
title: Karate Testomat Integration
description: Learn how to integrate Karate with Testomat.io for efficient test management and reporting. The guide covers importing Karate tests, managing parameterized tests, reporting artifacts like screenshots and logs, enabling the Trace Viewer, and configuring parallel execution reporting for CI workflows.
type: article
url: https://docs.testomat.io/tutorials/karate-testomat-integration
head:
  - tag: meta
    attrs:
      name: og:image
  ...
  - tag: meta
    attrs:
      name: keywords
      content: Karate, Testomat.io, integration, test management, test reporting, test import
---
...
![Testomat.io - Import Project from Source Code](./images/karate-integration.png)
