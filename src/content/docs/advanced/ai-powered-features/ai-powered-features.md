...
**Generate Project Structure** helps you plan how to reorganize a growing test project. Testomat.io analyzes your existing folders, suites, and test distribution, asks about your priorities, and returns a visual mind map of the recommended structure.
