...
When you open a Jira issue with linked Testomat.io items **without logging in**, the visibility depends on how Jira is connected:

![Jira Connection Type](./images/att22_401.png)
...
- You **won’t be able to see tests or run results** without logging in
