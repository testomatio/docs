---
title: Work with Branches in Jira
description: Learn how to manage branches in the Testomat.io Jira plugin. This guide covers creating new branches, switching between branches and the main project, and working with tests and suites within branches directly in Jira.
type: article
url: https://docs.testomat.io/advanced/jira-plugin/branches
head:
  - tag: meta
    attrs:
  - tag: meta
...
![Switch to Main](./images/att13_401.png)
...
![Branch badge](./images/att40_401.png)
