...
type: article
url: https://docs.testomat.io/management/company/subscriptions
head:
  - tag: meta
    attrs:
      name: keywords
...
- **Yearly billing:** Charged **per user, per year**, typically at a discounted rate compared to monthly billing (e.g., $324 × 10 users = $3,240/year).
