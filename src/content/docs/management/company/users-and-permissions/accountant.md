---
title: Accountant User Role in Testomat.io
description: Learn how the Accountant user role works in Testomat.io, including permissions, restrictions, and how to assign this role for free to manage billing and financial tasks.
url: https://docs.testomat.io/management/company/users-and-permissions/accountant
head:
  - tag: meta
    attrs:
      name: keywords
      content: Testomat.io accountant role, billing permissions, financial access, manage subscriptions, add accountant user, billing management, billing role, financial reports, payment tracking, read-only access for accountant
---
