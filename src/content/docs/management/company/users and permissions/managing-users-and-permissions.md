...
type: article
url: https://docs.testomat.io/management/company/users-and-permissions/managing-users-and-permissions
head:
  - tag: meta
    attrs:
      name: keywords
...
Each user may belong to only one company to ensure project separation and clear access control.
