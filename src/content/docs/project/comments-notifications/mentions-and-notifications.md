...
description: Mention a teammate with @ in a Testomat.io comment, and see how the notification reaches them. This guide covers adding a mention, who can be mentioned, the notifications bell, and mention emails.
type: article
url: https://docs.testomat.io/project/comments-notifications/mentions-and-notifications
head:
  - tag: meta
    attrs:
      name: keywords
...
A mention invites the teammate to a comment. The teammates are notified right away. Mentions work inside a comment on a test or a suite.
...
![Mentioning a teammate in a comment on a test](./images/1-mention-teammate.png)
...
![How a new comment notifies everyone already in the thread](./images/thread-notifications.png)
...
![The notifications bell and panel in the left navigation](./images/2-notification-tab.png)
